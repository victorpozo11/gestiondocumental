...
alter table HISTORICO_INFORMACION add constraint FK_RELATIONSHIP_21 foreign key (ID_ANTECEDENTES_PATOLOGICOS)
      references ANTECEDENTES_PATOLOGICOS (ID_ANTECEDENTES_PATOLOGICOS) on delete restrict on update restrict;

alter table HISTORICO_INFORMACION add constraint FK_RELATIONSHIP_22 foreign key (ID_ESTRUCTURA_Y_FUNCION_ORAL)
