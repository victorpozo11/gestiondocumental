...
class RegionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regions = $em->getRepository('IfeeBundle:Region')->findAll();
    ...
    {
        $region = new Region();
        $form = $this->createForm('IfeeBundle\Form\RegionType', $region);
     ...
     *
     * @Route("/{idRegion}", name="region_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{idRegion}/edit", name="region_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Region $region)
    {
        $deleteForm = $this->createDeleteForm($region);
        $editForm = $this->createForm('IfeeBundle\Form\RegionType', $region);
     ...
     *
     * @Route("/{idRegion}", name="region_delete")
     * @Method("DELETE")
     */
